    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_website', models.URLField(blank=True, default='https://example.com', null=True)),
                ('industry', models.CharField(blank=True, default='Unknown Industry', max_length=100, null=True)),
                ('company_address', models.TextField(blank=True, default='No address provided', null=True)),
                ('contact_name', models.CharField(default='Unknown Contact', max_length=100)),
                ('company_email', models.EmailField(default='company@example.com', max_length=254)),
                ('company_phone', models.CharField(blank=True, default='0000000000', max_length=16, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(blank=True, default='student@example.com', max_length=254, null=True, unique=True)),
